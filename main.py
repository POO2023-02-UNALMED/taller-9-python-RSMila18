...
#Realmente intente varias veces y de ningun modo me daba, me ayudo un amigo y compañero de curso que tuvo que ver un video, i'm sorry :c
...
def obtenerOperador(operador):
    ...
    global operadores
    if operadores == 0:
        pantalla.insert(count, operador)
        count+=1
        operadores+=1
    else:
        clear_pantalla()
